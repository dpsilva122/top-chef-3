...
<div class="container scroll-container">
  <section class="scroll-sequence__container topchef-container">
    <div class="scroll-sequence topchef-sequence"></div>
    <div class="scroll-sequence__content">
      <div class="speak"><h1>&nbsp;</h1><p></p></div>
      <div class="speak"><h1>&nbsp;</h1><p></p></div>
      <div class="speak"><h1>&nbsp;</h1><p></p></div>
      <div class="speak"><h1>&nbsp;</h1><p></p></div>
      <div class="speak"><h1>&nbsp;</h1><p></p></div>
...
<script>
const topchefSequenceImages = [];
// const treeSequenceImages = [];

for (let i = 0; i <= 1117; i ++) {
  topchefSequenceImages.push(`${`000${i}`.slice(-4)}.jpg`);
}
// for (let i = 0; i <= 298; i ++) {
...
const topchefSequence = new ScrollSequence({
  container: '.topchef-sequence',
  scrollWith: '.topchef-container',
  images: topchefSequenceImages,
  ...
  imagesRoot: 'http://www.comercial.recordtv.com.br/top-chef/imagens/scroll/',
  priorityFrames: [0],
  cover: true,
...
//   imagesRoot: 'http://www.comercial.recordtv.com.br/teste/images/',
