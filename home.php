  ...
  <div class="arrows">
    ...
    <label class="goto-last" for="slides_8"></label> -->
		...
		<div class="hide-mobile">
			...
			<div id="v0box">
				<video id="v0" tabindex="0" autobuffer preload>
					<source type="video/mp4; codecs=&quot;avc1.42E01E, mp4a.40.2&quot;" src="<?=$url?>imagens/videos/def-mec8.mp4"></source>
		...
		<div class="conteudo-index3 desliza" id="secagendar">
			...
			<div class="time-line">
				<div class="mar"></div>
				<a href="<?=$url?>home#slide-1">1</a>
				<a href="<?=$url?>home#slide-2">2</a>
				<a href="<?=$url?>home#slide-3">3</a>
				<a href="<?=$url?>home#slide-4">4</a>
				<a href="<?=$url?>home#slide-5">5</a>
				<a href="<?=$url?>home#slide-6">6</a>
				<a href="<?=$url?>home#slide-7">7</a>
				<a href="<?=$url?>home#slide-8">8</a>
				<a href="<?=$url?>home#slide-9">9</a>
				<a href="<?=$url?>home#slide-10">10</a>
				<a href="<?=$url?>home#slide-11">11</a>
				<a href="<?=$url?>home#slide-12">12</a>
			</div>
		...
		<!-- <div class="icon-scroll"><div/> -->
			<a href="<?=$url?>home#set-height" class="hide-mobile"><img src="<?=$url?>imagens/sec1/seta-portal.gif" class="icon-scroll" alt=""></a>
			<a href="<?=$url?>home#def-mob" class="hide-desktop"><img src="<?=$url?>imagens/sec1/seta-portal.gif" class="icon-scroll" alt=""></a>
