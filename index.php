...
<![endif]>
  ...
  <div id="slide-window">
    ...
    <span class="nav fa fa-chevron-right fa-3x setas-slide" id="right"></span>
		...
		<video autoplay muted loop src="<?=$url?>imagens/videos/mecanica-bg2.mp4" class="mecanica-bg"></video>
...
<div class="csslider infinity" id="slider1">
  ...
  <ul>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-01.png"/>
    </li>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-02.png"/>
    </li>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-03.png"/>
    </li>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-04.png"/>
    </li>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-05.png"/>
    </li>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-06.png"/>
    </li>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-07.png"/>
    </li>
    <li>
      <img class="mec-ajust" src="<?=$url?>imagens/mecanica/mecanica-08.png"/>
    </li>
  </ul>
  ...
  <div class="arrows">
    ...
    <label class="goto-last" for="slides_8"></label> -->
  </div>
		...
		<div class="hide-mobile">
			...
			<div id="v0box">
				<video id="v0" tabindex="0" autobuffer preload>
					<source type="video/mp4; codecs=&quot;avc1.42E01E, mp4a.40.2&quot;" src="<?=$url?>imagens/videos/def-mec9.mp4"></source>
		...
		<!-- <div class="conteudo-index3 desliza" id="secagendar">
			...
			<div class="slider">
				...
				<div class="slides">
					<div id="slide-1">
						<img src="<?=$url?>imagens/sec6/setembro-01.png" class="calendario" alt="">
					</div>
					<div id="slide-2">
						<img src="<?=$url?>imagens/sec6/outubro-01.png" class="calendario" alt="">
					</div>
					<div id="slide-3">
						<img src="<?=$url?>imagens/sec6/outubro-02.png" class="calendario" alt="">
					</div>
					<div id="slide-4">
						<img src="<?=$url?>imagens/sec6/outubro-03.png" class="calendario" alt="">
					</div>
					<div id="slide-5">
						<img src="<?=$url?>imagens/sec6/outubro-04.png" class="calendario" alt="">
					</div>
					<div id="slide-6">
						<img src="<?=$url?>imagens/sec6/outubro-05.png" class="calendario" alt="">
					</div>
					<div id="slide-7">
						<img src="<?=$url?>imagens/sec6/novembro-01.png" class="calendario" alt="">
					</div>
					<div id="slide-8">
						<img src="<?=$url?>imagens/sec6/novembro-02.png" class="calendario" alt="">
					</div>
					<div id="slide-9">
						<img src="<?=$url?>imagens/sec6/novembro-03.png" class="calendario" alt="">
					</div>
					<div id="slide-10">
						<img src="<?=$url?>imagens/sec6/novembro-04.png" class="calendario" alt="">
					</div>
					<div id="slide-11">
						<img src="<?=$url?>imagens/sec6/dezembro-01.png" class="calendario" alt="">
					</div>
					<div id="slide-12">
						<img src="<?=$url?>imagens/sec6/dezembro-02.png" class="calendario" alt="">
					</div>
				</div>
		...
		<!-- <div class="icon-scroll"><div/> -->
			...
			<a href="<?=$url?>#def-mob" class="hide-desktop"><img src="<?=$url?>imagens/sec1/seta-portal.gif" class="icon-scroll" alt=""></a>
